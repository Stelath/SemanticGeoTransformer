...
# data
_C.data = edict()
_C.data.metadata_name = "metadataNamespace(max_spacing_m=5.2, max_xyz_mag=100, min_spacing_m=4.8, plot_sequences=False, spacing=8)"
