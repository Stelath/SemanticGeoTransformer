...
_C.output_dir = osp.join(_C.root_dir, 'output', 'geotransformer.rellis.singleattsemantic')#_C.exp_name)
...
_C.geotransformer.model_type = 'SemanticSingleAttnTransformer'
