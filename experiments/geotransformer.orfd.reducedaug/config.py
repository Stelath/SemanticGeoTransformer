...
# data
_C.data = edict()
_C.data.dataset_root = osp.join(_C.root_dir, 'data', 'ORFD','Final_Dataset')
...
_C.train.augmentation_shift = 1.0
_C.train.augmentation_rotation = 0.5
_C.train.augmentation_z_priority_rotation = True
...
_C.geotransformer.hidden_dim = 32
_C.geotransformer.output_dim = 256
_C.geotransformer.num_heads = 1
_C.geotransformer.blocks = ['self', 'cross', 'self']
