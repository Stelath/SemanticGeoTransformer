from geotransformer.datasets.registration.orfd.dataset import OdometryORFDPairDataset
...
def train_valid_data_loader(cfg, distributed):
    ...
    train_dataset = OdometryORFDPairDataset(
    ...
    valid_dataset = OdometryORFDPairDataset(
        cfg.data.dataset_root,
        'val',
...
def test_data_loader(cfg):
    ...
    test_dataset = OdometryORFDPairDataset(
        cfg.data.dataset_root,
        'test',
        point_limit=cfg.test.point_limit,
        use_augmentation=False,  
