...
class OdometryTartan2PairDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        augmentation_z_priority_rotation=False, 
    ):
        ...
        self.augmentation_z_priority_rotation = augmentation_z_priority_rotation
    ...
    def __getitem__(self, index):
        ...
        ref_points = self._load_point_cloud(osp.join("/project/bli4/maps/wacv/GeoTransformer/", metadata['pc0']))
        src_points = self._load_point_cloud(osp.join("/project/bli4/maps/wacv/GeoTransformer/", metadata['pc1']))
